...
if(isset($_POST['import'])){
	...
	if($drop == 1 ){
		$truncate = "TRUNCATE TABLE t_n_sekolah";
	...
	// Buat query Insert
	$query = "INSERT INTO t_n_sekolah VALUES";
	...
	if($hasil){
		mysqli_query($conn, "INSERT INTO t_history VALUES('', 'import nilai USBN siswa', '$_SESSION[user]', NULL) ");

		echo "
				<script>
					alert('Data Berhasil Di import');
					window.location.href = '../../beranda.php?page=".base64_encode("nilai_us")."';
				</script>
		...
		echo "
				<script>
					...
					window.location.href = '../../beranda.php?page=".base64_encode("nilai_us")."&action=".base64_encode("impor_n_us")."';
				</script>
