<fieldset>
	<legend>Import Nilai Rapor</legend>
	...
	<form action="" method="post" enctype="multipart/form-data">
		<a href="admin/impor/format_import_nilai_rapor_siswa.xlsx" class="btn btn-default pull-left">
		...
		<a href="?page=<?= base64_encode("nilai_r"); ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-remove"></span> Batal </a>
	...
	if(isset($_POST['preview'])){
		...
		if($tipe_file == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
			...
			echo "<form method='post' action='admin/impor/impor_n_r.php'>";
