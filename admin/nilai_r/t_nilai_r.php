<fieldset>
	<legend>Masukan Nilai Rapor</legend>
	...
	if(isset($_POST['tambah'])){
		if($nama == "" || $no_pes == "" || $pai == "" || $ppkn == "" || $ind == "" || $mtk == "" || $sejind == "" || $ing == "" || $senbud == "" || $pjok == "" || $pkwu == "" || $mat_sej == "" || $fis_eko == "" || $kim_sos == "" || $bio_geo == "" || $lm == ""){
			...
			<?php
				...
				mysqli_query($conn, "INSERT INTO t_n_rapor VALUES('$nama', '$no_pes', '$pai', '$ppkn', '$ind', '$mtk', '$sejind', '$ing', '$senbud', '$pjok', '$pkwu', '$mat_sej', '$fis_eko', '$kim_sos', '$bio_geo', '$lm')");
				mysqli_query($conn, "INSERT INTO t_history VALUES('', 'tambah nilai $nama', '$_SESSION[user]', NULL) ");
				?>
				<script type="text/javascript"> alert("Nilai sudah di tambah"); window.location.href="?page=<?= base64_encode("nilai_r"); ?>"; </script>
