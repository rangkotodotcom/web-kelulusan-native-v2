...
<body style="background-image: url(../img/tetap/back.jpg);">
			...
			if(strlen($pass) > 15 || strlen($pass) < 8 ){
				echo "
						<script>
							...
							window.location.href='ganti_pass.php?user=".base64_encode($_SESSION['user'])."';
						</script>
					 ";
			}else{
				$edit = mysqli_query($conn, "UPDATE t_luser SET pass = '$pass', ganti = 'sudah' WHERE user = '$kd' " );
