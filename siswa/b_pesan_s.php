		...
		<table class="table table-striped" width="100%">
			...
			<tr>
				...
				<td>
					...
					<a href="?page=<?= base64_encode("pesan_s"); ?>" class="btn btn-warning btn-sm">
	...
	if(isset($_POST['kirim'])){
		if($penerima == "" || $isi == ""){
			...
			<script type="text/javascript"> 
				...
				window.location.href="?page=<?= base64_encode("pesan_s"); ?>&action=<?= base64_encode("b_pesan_s"); ?>";
			</script>
			...
			<script type="text/javascript"> 
				...
				window.location.href="?page=<?= base64_encode("pesan_s"); ?>";
			</script>
